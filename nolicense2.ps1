...
$day = $date.Day
$year = $date.Year
$fileLocation = "D:\backup 4-8-2014\powershell\nolicense-" + $month + "-" + $day + "-" + $year + ".csv" 
...
$findObj = $xml.objs.'Obj'  | ForEach-Object {$_.CreateNavigator().SelectChildren('Element').Value}
 ...
 Set-MsolUser -UserPrincipalName 'jortiz@tcicollege.edu' -UsageLocation "US"
 Set-MsolUserLicense -UserPrincipalName 'jortiz@tcicollege.edu' -AddLicenses tcicollege0:STANDARDWOFFPACK_IW_FACULTY
 Get-MsolAccountSku | Select -ExpandProperty ServiceStatus
  $role = Get-MsolRole -RoleName “Company Administrator”
  Get-MsolRoleMember -RoleObjectId $role.ObjectId


 Add-MsolRoleMember -RoleName “Company Administrator” –RoleMemberEmailAddress Mnauala@tcicollege.edu