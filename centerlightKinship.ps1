...
foreach($user in $newusers) 
{
    ...
    if($user.UserPrincipalName -notmatch "@kinshiphs.com") 
    {
        ...
        Set-ADUser $emailalias -Replace @{UserPrincipalName=$kinshipEmail}
        Set-ADUser $emailalias -Replace @{mail=$kinshipEmail}
        }    
    ...
    else 
    {
        ...
        write-host $emailalias "already has a mailbox"
    }
