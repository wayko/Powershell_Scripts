...
{   
	...
	$Session = New-PSSession -ConfigurationName Microsoft.Exchange -ConnectionUri https://bl2pr01psh.outlook.com/powershell-liveid?PSVersion=3.0 -Credential $Office365credentials -Authentication Basic –AllowRedirection    	
